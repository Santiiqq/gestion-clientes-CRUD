...
import com.gestion.clientes.exeption.ResourceNotFoundExeption;
...
public class ClienteController {
   ...
   private ClienteRepository clienteRepository;
    ...
    public ResponseEntity<Cliente> listarClienterPorID(@PathVariable Long id){
        Cliente cliente = clienteRepository.findById(id)
        .orElseThrow(()-> new ResourceNotFoundExeption("El cliente con ese ID no ha sido encontrado: "+ id));
